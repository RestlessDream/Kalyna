...
const size_t dword_size = sizeof(dw) * byte_size;
const size_t dword_bsize = sizeof(dw);
const size_t rows_count = 8;
const size_t max_block_dwsize = 512 / dword_size;
const size_t s_box_dimensions = S_BOX_DIMENSION;

standart_config Kalyna_128_128 = { 128 / dword_size, 128 / dword_size, 10, 2 };
standart_config Kalyna_128_256 = { 128 / dword_size, 256 / dword_size, 14, 2 };
standart_config Kalyna_256_256 = { 256 / dword_size, 256 / dword_size, 14, 4 };
standart_config Kalyna_256_512 = { 256 / dword_size, 512 / dword_size, 18, 4 };
standart_config Kalyna_512_512 = { 512 / dword_size, 512 / dword_size, 18, 8 };
